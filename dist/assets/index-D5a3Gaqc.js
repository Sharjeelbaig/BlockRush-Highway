...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(e,t,n){let r=new Float32Array(no),i=new W(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:bo(),fragmentShader:`
	...
	`}var xo=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},ll=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},ul=new ba(-1,1,1,-1,0,1),dl=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new vr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new vr([0,2,0,0,2,0],2))}},fl=class{constructor(e){this._mesh=new $r(dl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ul)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},pl=class extends ll{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ii?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ni.clone(e.uniforms),this.material=new Ii({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new fl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ml=class extends ll{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},hl=class extends ll{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},gl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:ie}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new pl(cl),this.copyPass.material.blending=0,this.timer=new Oa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ml!==void 0&&(r instanceof ml?n=!0:r instanceof hl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},_l={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},xl=class e extends ll{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new U(256,256):new U(e.x,e.y),this.clearColor=new K(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Yt(i,a,{type:ie}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Yt(i,a,{type:ie});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Yt(i,a,{type:ie});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=bl;this.highPassUniforms=Ni.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Ii({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Ni.clone(cl.uniforms),this.blendMaterial=new Ii({uniforms:this.copyUniforms,vertexShader:cl.vertexShader,fragmentShader:cl.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new K,this._oldClearAlpha=1,this._basic=new Vr,this._fsQuad=new fl(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Ii({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new U(.5,.5)},direction:{value:new U(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};xl.BlurDirectionX=new U(1,0),xl.BlurDirectionY=new U(0,1);var Sl=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),Q=o(((e,t)=>{t.exports=Sl()}))(),Cl=1.35,wl=[-2.7,0,Cl*2],Tl=3.2,El=18,Dl=116,Ol=.18,kl=.52,Al=68,jl=224,Ml=22,Nl=2,Pl=12.95,Fl=3.15,Il=35,Ll=8,Rl=[`clear_noon`,`sunny_golden_hour`,`rain_dusk`,`thunder_night`,`snow_dawn`],zl={clear_noon:{skyTop:new K(3907552),skyHorizon:new K(9751007),skyHaze:new K(9156810),fogColor:new K(9091272),fogNear:92,fogFar:215,sunColor:new K(16769191),sunIntensity:2.35,sunPosition:new W(-15,22,13),sunDirection:new W(-.5,.72,.22).normalize(),ambientIntensity:.24,hemiIntensity:.68,fillIntensity:.22,rimIntensity:.42,bloomStrength:.055,bloomThreshold:1.16,exposure:.82,saturation:1.08,contrast:1.12,gradeTint:new K(15924223),roadWetness:0,snowCover:0,rainAmount:0,snowAmount:0,thunderAmount:0,particleType:`none`,cloudOpacity:.34,lampIntensity:.12,lampGlowOpacity:.012,headlightBoost:.08},sunny_golden_hour:{skyTop:new K(4101586),skyHorizon:new K(14655336),skyHaze:new K(13210991),fogColor:new K(13144936),fogNear:72,fogFar:190,sunColor:new K(16758110),sunIntensity:2.6,sunPosition:new W(-24,12,-24),sunDirection:new W(-.74,.36,-.34).normalize(),ambientIntensity:.19,hemiIntensity:.56,fillIntensity:.16,rimIntensity:.58,bloomStrength:.075,bloomThreshold:1.08,exposure:.86,saturation:1.14,contrast:1.15,gradeTint:new K(16771792),roadWetness:0,snowCover:0,rainAmount:0,snowAmount:0,thunderAmount:0,particleType:`none`,cloudOpacity:.28,lampIntensity:.14,lampGlowOpacity:.018,headlightBoost:.1},rain_dusk:{skyTop:new K(3163231),skyHorizon:new K(11565926),skyHaze:new K(7902632),fogColor:new K(7702681),fogNear:24,fogFar:104,sunColor:new K(16750696),sunIntensity:1.35,sunPosition:new W(-18,7.5,-28),sunDirection:new W(-.62,.22,-.42).normalize(),ambientIntensity:.18,hemiIntensity:.5,fillIntensity:.14,rimIntensity:.76,bloomStrength:.3,bloomThreshold:.82,exposure:.78,saturation:.96,contrast:1.13,gradeTint:new K(14477823),roadWetness:.82,snowCover:0,rainAmount:1,snowAmount:0,thunderAmount:.08,particleType:`rain`,cloudOpacity:.82,lampIntensity:1.35,lampGlowOpacity:.1,headlightBoost:.56},thunder_night:{skyTop:new K(462882),skyHorizon:new K(1386816),skyHaze:new K(4018800),fogColor:new K(4346213),fogNear:13,fogFar:76,sunColor:new K(8631295),sunIntensity:.3,sunPosition:new W(10,10,-36),sunDirection:new W(.16,.24,-.76).normalize(),ambientIntensity:.075,hemiIntensity:.18,fillIntensity:.06,rimIntensity:1.05,bloomStrength:.48,bloomThreshold:.72,exposure:.64,saturation:.82,contrast:1.22,gradeTint:new K(13098239),roadWetness:1,snowCover:0,rainAmount:.95,snowAmount:0,thunderAmount:1,particleType:`rain`,cloudOpacity:.9,lampIntensity:2.35,lampGlowOpacity:.2,headlightBoost:.98},snow_dawn:{skyTop:new K(10471652),skyHorizon:new K(16766653),skyHaze:new K(12176341),fogColor:new K(11452618),fogNear:42,fogFar:145,sunColor:new K(16761506),sunIntensity:1.55,sunPosition:new W(-10,9,-18),sunDirection:new W(-.34,.32,-.52).normalize(),ambientIntensity:.42,hemiIntensity:.78,fillIntensity:.28,rimIntensity:.66,bloomStrength:.14,bloomThreshold:.94,exposure:.82,saturation:.86,contrast:1.06,gradeTint:new K(15464191),roadWetness:.16,snowCover:.72,rainAmount:0,snowAmount:1,thunderAmount:0,particleType:`snow`,cloudOpacity:.58,lampIntensity:.46,lampGlowOpacity:.055,headlightBoost:.22}},Bl={uniforms:{tDiffuse:{value:null},uTime:{value:0},uSpeed:{value:0},uGrain:{value:0},uVignette:{value:1.18},uChromatic:{value:.0016},uTint:{value:new W(1,1,1)},uSaturation:{value:1.12},uContrast:{value:1.08}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function Vl(e,t,n){return Math.min(n,Math.max(t,e))}function $(e,t,n){return e+(t-e)*n}function Hl(e){let t=Vl(e,0,1);return t<.5?4*t*t*t:1-(-2*t+2)**3/2}function Ul(e){let t=(e-Ol)/(kl-Ol);return Math.round(Al+Vl(t,0,1)*(jl-Al))}function Wl(){let e=(0,_.useRef)(null),t=(0,_.useRef)(null),n=(0,_.useRef)({started:!1,gameOver:!1,score:0,speed:Ol,lane:1,targetX:0,obstacles:[],animatedRoadItems:[],wheelGroups:[],weatherState:null,animationId:null,resetGame:null,moveLane:null,lastUiScore:-1,lastUiSpeed:-1}),[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(Ul(Ol)),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let t=e.current;if(!t)return;let r=n.current;r.animatedRoadItems=[],r.obstacles=[],r.wheelGroups=[],r.weatherState={elapsed:0,fromPreset:Rl[0],toPreset:Rl[1],transitionProgress:0,lightningCooldown:5.5,lightningFlash:0,lightningX:0};let a=performance.now(),s=1,l=0,d=0,p=performance.now(),m=window.matchMedia(`(pointer: coarse)`).matches,h=navigator.hardwareConcurrency||8,g=navigator.deviceMemory||8,_=m||h<=6||g<=4,v=_?.65:.75,y=_?1:1.25,b=new In;b.background=zl.clear_noon.skyTop.clone(),b.fog=new Fn(zl.clear_noon.fogColor.getHex(),zl.clear_noon.fogNear,zl.clear_noon.fogFar);let x=new _a(58,t.clientWidth/t.clientHeight,.1,200);x.position.set(0,Nl,Pl+(t.clientWidth<700?Fl:0)),x.lookAt(0,.72,1.62);let S=new al({antialias:!_,powerPreference:`high-performance`});S.outputColorSpace=et,S.toneMapping=4,S.toneMappingExposure=.98,S.shadowMap.enabled=!1,S.domElement.style.touchAction=`none`,t.appendChild(S.domElement);let C=new fo(S),w=C.fromScene(new ol,.04).texture;b.environment=w;let T=new xo(_?32:64,{generateMipmaps:!0,minFilter:D}),E=new Ea(.25,90,T);b.add(E);let O=null,ee=new U;function k(){if(!t)return;let e=Math.min(window.devicePixelRatio||1,y*s);ee.set(t.clientWidth,t.clientHeight),S.setPixelRatio(e),S.setSize(ee.x,ee.y,!1),O&&(O.setPixelRatio(e),O.setSize(ee.x,ee.y))}k();let te=new Ca(16777215,.22);b.add(te);let ne=new aa(13233407,3428144,.84);b.add(ne);let re=new Sa(16772543,2.55);re.position.set(-15,22,13),re.castShadow=!1,b.add(re);let A=new Sa(9558015,.28);A.position.set(8,6,12),b.add(A);let ie=new Sa(15661311,.58);ie.position.set(0,4,-12),b.add(ie);let j=new ya(13625087,0,95,1.8);j.position.set(0,18,-42),b.add(j);let M=new Dn;b.add(M);let ae={time:{value:0},speed:{value:0},roadWetness:{value:0},snowCover:{value:0},skySunDirection:{value:new W(-.5,.72,.22).normalize()}},N={sky:new Ii({side:1,depthWrite:!1,depthTest:!1,uniforms:{uTime:ae.time,uSunDirection:ae.skySunDirection,uZenith:{value:new K(6272255)},uHorizon:{value:new K(13036543)},uHaze:{value:new K(15661311)},uSunColor:{value:new K(16763238)},uLightning:{value:0}},vertexShader:`
          varying vec3 vWorldPosition;
          void main() {
        ...
        `}),ground:new J({color:5154906,roughness:1}),grassDark:new J({color:4165449,roughness:1}),grassLight:new J({color:7518045,roughness:1}),field:new J({color:9418843,roughness:1}),crop:new J({color:13678682,roughness:.96}),road:new J({color:2304562,roughness:.82,metalness:.04,envMapIntensity:.9}),roadPatch:new J({color:3160129,roughness:.86,metalness:.03,envMapIntensity:1.05}),puddle:new Ri({color:8233656,roughness:.03,metalness:.02,clearcoat:1,clearcoatRoughness:.02,transparent:!0,opacity:0,depthWrite:!1,envMapIntensity:2.2}),tireMark:new Vr({color:921878,transparent:!0,opacity:.22,depthWrite:!1}),shoulder:new J({color:5133401,roughness:.95}),shoulderLight:new J({color:6844533,roughness:.96}),laneLine:new Vr({color:14145745}),edgeLine:new Vr({color:14003534}),rumbleRed:new J({color:13123391,roughness:.9}),rumbleWhite:new J({color:12567228,roughness:.85}),barrier:new J({color:10463146,roughness:.86}),barrierTop:new J({color:6911099,roughness:.74,metalness:.08}),reflector:new J({color:13805658,emissive:16748316,emissiveIntensity:.08,roughness:.42}),sidewalk:new J({color:11117723,roughness:.82}),curb:new J({color:12762805,roughness:.78}),cityWall:new J({color:11048323,roughness:.86}),cityWallCool:new J({color:8358549,roughness:.82}),cityDarkWall:new J({color:6186864,roughness:.78}),cityWindow:new J({color:2439498,emissive:1319729,emissiveIntensity:.04,roughness:.2,metalness:.18}),planter:new J({color:9075558,roughness:.88}),signPost:new J({color:9082011,roughness:.45,metalness:.45}),signBoard:new J({color:1931869,roughness:.65}),signBack:new J({color:2634815,roughness:.7}),lampPost:new J({color:6121586,roughness:.5,metalness:.35}),lampHead:new J({color:16771235,emissive:16762967,emissiveIntensity:.9,roughness:.22}),lampGlow:new Vr({color:15050831,transparent:!0,opacity:0,blending:2,depthWrite:!1}),mountain:new J({color:7636890,roughness:1}),mountainSnow:new J({color:12569552,roughness:.88}),trunk:new J({color:7029286,roughness:1}),leaves:new J({color:2325051,roughness:1}),leavesDark:new J({color:1400626,roughness:1}),bush:new J({color:3050055,roughness:1}),flower:new J({color:16240989,roughness:.8}),buildingWall:new J({color:14140833,roughness:.9}),buildingRoof:new J({color:10173745,roughness:.85}),window:new J({color:9361407,emissive:2979238,emissiveIntensity:.14,roughness:.2,metalness:.15}),chimney:new J({color:8212800,roughness:.9}),cloud:new Vr({color:11977416,transparent:!0,opacity:.34,depthWrite:!1}),sunBlock:new Vr({color:16765286}),rainStreak:new Vr({color:11065599,transparent:!0,opacity:0,blending:2,depthWrite:!1}),snowFlake:new Vr({color:16251903,transparent:!0,opacity:0,depthWrite:!1}),playerBody:new Ri({color:1387672,roughness:.09,metalness:.34,clearcoat:1,clearcoatRoughness:.018,reflectivity:1,envMapIntensity:1.55}),playerAccent:new Ri({color:461586,roughness:.12,metalness:.36,clearcoat:1,clearcoatRoughness:.035,reflectivity:1,envMapIntensity:1.35}),black:new J({color:461586,roughness:.38,metalness:.22}),glass:new Ri({color:1186339,roughness:.05,metalness:.22,transparent:!0,opacity:.72,clearcoat:1,clearcoatRoughness:.035,transmission:0,thickness:.22,envMapIntensity:1.7}),chrome:new Ri({color:8687770,roughness:.1,metalness:.9,clearcoat:.8,clearcoatRoughness:.05,envMapIntensity:1.35}),grille:new J({color:724757,roughness:.55,metalness:.55}),plate:new Vr({color:13154438}),wheel:new J({color:1118481,roughness:.8}),rim:new Ri({color:12107976,roughness:.12,metalness:.94,clearcoat:.75,clearcoatRoughness:.04,envMapIntensity:1.9}),headlight:new J({color:14139780,emissive:16760157,emissiveIntensity:.16,roughness:.18,metalness:.18}),headlightGlow:new Vr({color:16761963,transparent:!0,opacity:0,blending:2,depthWrite:!1}),headlightReflection:new Vr({color:16757851,transparent:!0,opacity:0,blending:2,depthWrite:!1}),taillight:new J({color:11607597,emissive:11013398,emissiveIntensity:.28,roughness:.24,metalness:.1}),contactShadow:new Vr({color:0,transparent:!0,opacity:.24,depthWrite:!1})},oe=new K(12174791),se=new K(10004658),ce=new Map([N.ground,N.grassDark,N.grassLight,N.field,N.crop,N.leaves,N.leavesDark,N.bush,N.mountain,N.barrier,N.barrierTop,N.shoulder,N.shoulderLight,N.sidewalk,N.curb,N.cityWall,N.cityWallCool,N.cityDarkWall,N.planter].map(e=>[e,e.color.clone()]));[N.playerBody,N.playerAccent,N.glass,N.chrome,N.rim].forEach(e=>{e.envMap=T.texture,e.needsUpdate=!0});let P={sky:new Di(145,36,18),ground:new q(150,.2,220),grassTile:new q(5.2,.05,5.2),fieldStrip:new q(5.8,.08,2.1),cropRow:new q(.12,.16,2.3),road:new q(8,.12,120),roadPatch:new q(1.35,.025,2.2),puddle:new q(1.25,.018,2.8),tireMark:new q(.12,.025,4.5),shoulder:new q(.4,.06,120),sidewalk:new q(3.2,.12,120),curb:new q(.22,.18,120),edgeLine:new q(.08,.035,4.8),rumble:new q(.34,.04,.7),laneLine:new q(.16,.03,2.6),barrier:new q(.45,.45,2.5),barrierTop:new q(.52,.12,2.45),reflector:new q(.08,.08,.16),signPost:new q(.12,1.9,.12),signBoard:new q(1.8,.8,.12),fencePost:new q(.14,.72,.14),fenceRail:new q(.12,.12,2.7),lampPole:new q(.12,3.1,.12),lampArm:new q(1,.1,.1),lampHead:new q(.36,.18,.28),lampHalo:new Di(.42,10,8),mountain:new Ti(5,8,4),mountainSnow:new Ti(2.3,2.6,4),trunk:new wi(.12,.16,1.2,8),leaves:new Ti(.7,1.6,10),bush:new q(.7,.46,.7),flower:new q(.12,.18,.12),houseBody:new q(2.6,1.6,2.4),houseRoof:new Ti(1.9,1,4),window:new q(.42,.38,.04),chimney:new q(.32,.7,.32),cityTower:new q(3.4,5.4,3),cityShop:new q(3,2.2,2.4),cityWindow:new q(.48,.52,.05),awning:new q(2.2,.18,.48),planter:new q(1,.42,1),cloudBlock:new q(1.4,.7,.7),sunBlock:new q(2.2,2.2,.08),rainStreak:new q(.026,.9,.026),snowFlake:new q(.1,.1,.1),carBody:new q(1.35,.42,2.3),carHood:new q(1.2,.18,.7),carRear:new q(1.15,.2,.55),playerCabin:new q(.95,.45,1.05),hoodStripe:new q(.18,.035,1.65),sideSkirt:new q(.12,.16,1.72),mirror:new q(.18,.12,.22),roofScoop:new q(.42,.14,.48),spoiler:new q(1.25,.1,.24),grille:new q(.7,.18,.08),plate:new q(.36,.16,.04),exhaust:new q(.18,.12,.26),headlightBeam:new q(.34,.02,2.6),headlightReflection:new q(.52,.015,3.9),windshield:new q(.86,.28,.35),rearGlass:new q(.82,.22,.28),bumper:new q(1.18,.14,.18),headlight:new q(.18,.1,.08),taillight:new q(.2,.1,.08),tire:new wi(.24,.24,.26,14),rim:new wi(.13,.13,.27,10),obstacleBody:new q(1.25,.42,2.05),obstacleCabin:new q(.85,.36,.85),obstacleGlass:new q(.75,.22,.6),obstacleWheel:new wi(.21,.21,.22,12),contactShadowPlayer:new Ei(1.6,2.8),contactShadowObstacle:new Ei(1.5,2.5)};function F(e,t,n,r=M,i=!1,a=!0){let o=new $r(e,t);return o.position.set(n[0],n[1],n[2]),o.castShadow=i,o.receiveShadow=a,r.add(o),o}function le(e,t,n=.22){let r=N.contactShadow.clone();r.opacity=n;let i=new $r(t,r);return i.rotation.x=-Math.PI/2,i.position.y=.025,e.add(i),i}function ue(e,t,n=.06){e.onBeforeCompile=e=>{e.uniforms.uSurfaceTime=ae.time,e.uniforms.uSurfaceSpeed=ae.speed,e.uniforms.uWeatherWetness=ae.roadWetness,e.uniforms.uSnowCover=ae.snowCover,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
varying vec3 vSurfaceWorldPosition;`).replace(`#include <worldpos_vertex>`,`#include <worldpos_vertex>
vSurfaceWorldPosition = worldPosition.xyz;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`
            #include <common>
            ...
            ${t===`road`?`
                ...
                roughnessFactor = clamp(roughnessFactor + (1.0 - shaderNoise) * ${n.toFixed(3)} - uWeatherWetness * (0.48 + wetPuddleRoughness * 0.34), 0.08, 1.0);
              `:`
                roughnessFactor = clamp(roughnessFactor + (1.0 - shaderNoise) * ${n.toFixed(3)}, 0.0, 1.0);
              `}
            `),t===`road`&&(e.fragmentShader=e.fragmentShader.replace(`#include <metalnessmap_fragment>`,`
            #include <metalnessmap_fragment>
            ...
            `))},e.customProgramCacheKey=()=>`blockrush-${t}-${n}`}function de(e,t=El,n=Dl,i=1.9){return r.animatedRoadItems.push({object:e,resetAfter:t,resetBy:n,speedMul:i}),e}[N.road,N.roadPatch,N.shoulder,N.shoulderLight].forEach(e=>ue(e,`road`,.08)),[N.ground,N.grassDark,N.grassLight,N.field,N.crop,N.leaves,N.leavesDark,N.bush].forEach(e=>ue(e,`grass`,.04)),ue(N.playerBody,`paint`,.03);let fe=new $r(P.sky,N.sky);fe.frustumCulled=!1,fe.renderOrder=-100,b.add(fe),F(P.ground,N.ground,[0,-.18,-50]),F(P.road,N.road,[0,-.05,-40]),F(P.shoulder,N.shoulder,[-4.2,0,-40]),F(P.shoulder,N.shoulder,[4.2,0,-40]),F(P.sidewalk,N.sidewalk,[-6.05,-.02,-40]),F(P.sidewalk,N.sidewalk,[6.05,-.02,-40]),F(P.curb,N.curb,[-4.72,.02,-40]),F(P.curb,N.curb,[4.72,.02,-40]);let pe=F(P.sunBlock,N.sunBlock,[-19,12.5,-48],M,!1,!1);function me(e,t,n,r=El,i=Dl,a=1.9){return de(F(e,t,n,M,!1,!1),r,i,a)}for(let e=-95;e<20;e+=6)[-1.35,Cl].forEach(t=>me(P.laneLine,N.laneLine,[t,.035,e]));for(let e=-98;e<22;e+=4.8)[-3.82,3.82].forEach(t=>me(P.edgeLine,N.edgeLine,[t,.04,e],22,124,1.9));for(let e=-106;e<22;e+=5.6){let t=wl[Math.floor(Math.random()*wl.length)];if(me(P.roadPatch,N.roadPatch,[t+(Math.random()-.5)*.55,.03,e],22,128,1.9),Math.random()>.45){let n=me(P.tireMark,N.tireMark,[t+.34,.045,e-1.4],22,128,1.9);n.rotation.y=(Math.random()-.5)*.06}}let he=[];for(let e=-104;e<14;e+=9.5){let t=wl[Math.floor(Math.random()*wl.length)],n=me(P.puddle,N.puddle,[t+(Math.random()-.5)*.42,.055,e],22,128,1.9);n.scale.set(.65+Math.random()*.75,1,.7+Math.random()*.95),n.rotation.y=(Math.random()-.5)*.08,he.push(n)}for(let e=-100;e<25;e+=2.8)[-4.45,4.45].forEach((t,n)=>{let r=(Math.floor(e)+n)%2==0?N.rumbleWhite:N.rumbleRed,i=me(P.rumble,r,[t,.035,e],22,124,1.9);i.rotation.y=Math.PI*.5});function ge(e,t,n){let r=new Dn;F(P.barrier,N.barrier,[0,.22,0],r,!1,!0),F(P.barrierTop,N.barrierTop,[0,.52,0],r,!1,!0),F(P.reflector,N.reflector,[-n*.24,.45,-.64],r,!1,!1),F(P.reflector,N.reflector,[-n*.24,.45,.64],r,!1,!1),r.position.set(e,0,t),M.add(r),de(r,22,124,1.9)}for(let e=-100;e<25;e+=5)[-5.3,5.3].forEach(t=>ge(t,e,Math.sign(t)));function _e(e,t,n,r=1){let i=new Dn;[[-.8,0,0],[0,.2,0],[.88,.02,0],[.28,-.16,.15]].forEach(([e,t,n],r)=>{F(P.cloudBlock,N.cloud,[e,t,n],i,!1,!1).scale.setScalar(r===1?1.18:.82+r*.06)}),i.position.set(e,t,n),i.scale.setScalar(r),M.add(i),de(i,42,150,.28)}for(let e=0;e<7;e++)_e(-28+e*9+Math.random()*4,9+Math.random()*3,-35-e*16,.9+Math.random()*.5);function ve(e,t,n){let r=new Dn,i=F(P.mountain,N.mountain,[0,3.8,0],r,!1,!0);i.scale.setScalar(n),i.rotation.y=Math.PI*.25;let a=F(P.mountainSnow,N.mountainSnow,[0,7*n,0],r,!1,!1);a.scale.setScalar(n*.52),a.rotation.y=Math.PI*.25,r.position.set(e,0,t),M.add(r),de(r,36,158,.55)}for(let e=0;e<15;e++)ve((e%2==0?-1:1)*(26+Math.random()*16),-88-e*7-Math.random()*24,.7+Math.random()*.8);function ye(e,t){let n=new Dn;F(P.fencePost,N.barrier,[0,.36,-1.18],n,!1,!0),F(P.fencePost,N.barrier,[0,.36,1.18],n,!1,!0),F(P.fenceRail,N.barrierTop,[0,.55,0],n,!1,!0),n.position.set(e,0,t),M.add(n),de(n,24,128,1.65)}for(let e=-102;e<24;e+=8)[-7.1,7.1].forEach(t=>ye(t,e));function be(e,t){let n=new Dn;F(P.trunk,N.trunk,[0,.6,0],n,!1,!1),F(P.leaves,N.leavesDark,[0,1.55,0],n,!1,!1),F(P.leaves,N.leaves,[0,2.1,0],n,!1,!1).scale.setScalar(.82),F(P.bush,N.bush,[.45,.24,.15],n,!1,!0),n.position.set(e,0,t),n.scale.setScalar(.85+Math.random()*.65),M.add(n),de(n,24,132,1.7)}function xe(e,t){let n=new Dn;F(P.fieldStrip,N.field,[0,.02,0],n,!1,!0);for(let e=-2;e<=2;e++)F(P.cropRow,N.crop,[e*.48,.16,0],n,!1,!1);n.position.set(e,-.02,t),M.add(n),de(n,24,132,1.48)}function Se(e,t){let n=new Dn;F(P.signPost,N.signPost,[0,.95,0],n,!1,!0),F(P.signBoard,N.signBoard,[0,1.85,0],n,!1,!1),F(P.signBoard,N.signBack,[0,1.82,-.08],n,!1,!1).scale.set(.88,.7,.55),F(P.reflector,N.reflector,[-.52,1.98,.08],n,!1,!1),F(P.reflector,N.reflector,[.52,1.98,.08],n,!1,!1),n.position.set(e*6.8,0,t),n.rotation.y=e<0?.04:-.04,M.add(n),de(n,26,140,1.8)}function Ce(e,t){let n=new Dn;F(P.lampPole,N.lampPost,[0,1.55,0],n,!1,!0),F(P.lampArm,N.lampPost,[-e*.42,3.04,0],n,!1,!0),F(P.lampHead,N.lampHead,[-e*.94,2.98,0],n,!1,!1),F(P.lampHalo,N.lampGlow,[-e*.94,2.98,0],n,!1,!1),n.position.set(e*5.85,0,t),M.add(n),de(n,26,132,1.75)}function we(e,t,n){let r=new Dn;F(P.houseBody,N.buildingWall,[0,.8,0],r,!1,!0);let i=F(P.houseRoof,N.buildingRoof,[0,1.92,0],r,!1,!0);i.rotation.y=Math.PI*.25,F(P.window,N.window,[-.66,.92,1.22],r,!1,!1),F(P.window,N.window,[.66,.92,1.22],r,!1,!1),F(P.chimney,N.chimney,[.72,2.25,-.4],r,!1,!0),r.position.set(e*(15+n%3*3.4),0,t),r.rotation.y=e<0?.18:-.18,M.add(r),de(r,30,150,1.25)}function Te(e,t,n){let r=new Dn,i=n%3==0?N.cityDarkWall:n%3==1?N.cityWallCool:N.cityWall,a=.82+n%4*.12;F(P.cityTower,i,[0,2.7*a,0],r,!1,!0).scale.set(.86+n%2*.18,a,.92+n%3*.08),F(P.cityShop,N.cityWall,[-e*.18,1.05,2.05],r,!1,!0).scale.set(1.06,.94,.82);let o=-e*(1.72+n%2*.22);for(let e=0;e<3;e++)for(let t=-1;t<=1;t++){let n=F(P.cityWindow,N.cityWindow,[o,1.8+e*1.05,t*.72-.2],r,!1,!1);n.rotation.y=Math.PI*.5}let s=F(P.awning,n%2==0?N.rumbleRed:N.signBoard,[o,1.72,1.65],r,!1,!1);s.rotation.y=Math.PI*.5,s.scale.set(.9,1,1.1),r.position.set(e*(9.2+n%3*1.3),0,t),r.rotation.y=e<0?.03:-.03,M.add(r),de(r,34,152,1.18)}function Ee(e,t,n){let r=new Dn;F(P.planter,N.planter,[0,.22,0],r,!1,!0),F(P.trunk,N.trunk,[0,.92,0],r,!1,!1).scale.set(.72,.95,.72),F(P.leaves,n%2==0?N.leavesDark:N.leaves,[0,1.9,0],r,!1,!1).scale.set(.95,.86,.95),r.position.set(e*6.75,0,t),M.add(r),de(r,26,132,1.65)}for(let e=-106;e<24;e+=8)[-1,1].forEach(t=>{let n=8+Math.random()*7,r=me(P.grassTile,Math.random()>.5?N.grassDark:N.grassLight,[t*n,-.055,e+(Math.random()-.5)*2.4],24,132,1.55);r.rotation.y=(Math.random()-.5)*.35});for(let e=-100;e<20;e+=10)be(-10-Math.random()*4,e+Math.random()*2),be(10+Math.random()*4,e+Math.random()*2);for(let e=-112;e<16;e+=18)xe(-18-Math.random()*5,e),xe(18+Math.random()*5,e+7);for(let e=-110;e<8;e+=28)Se(Math.random()>.5?-1:1,e+5),we(-1,e-2,Math.floor(Math.random()*5)),we(1,e-12,Math.floor(Math.random()*5));for(let e=-112;e<14;e+=18){let t=Math.floor((e+112)/18);Te(-1,e-3,t),Te(1,e+6,t+3),Ee(-1,e+5,t),Ee(1,e-5,t+1)}for(let e=-100;e<20;e+=18)Ce(-1,e),Ce(1,e+9);function De(e,t,n,i,a=P.tire){let o=new Dn,s=new $r(a,N.wheel);s.rotation.z=Math.PI/2,s.castShadow=!1,o.add(s);let c=new $r(P.rim,N.rim);return c.rotation.z=Math.PI/2,o.add(c),o.position.set(t,n,i),e.add(o),r.wheelGroups.push(o),o}let Oe=[];function ke(){let e=new Dn;le(e,P.contactShadowPlayer,.24),F(P.carBody,N.playerBody,[0,.45,0],e,!1,!1),F(P.carHood,N.playerBody,[0,.62,-.65],e,!1,!1),F(P.carRear,N.playerBody,[0,.62,.75],e,!1,!1),F(P.hoodStripe,N.playerAccent,[0,.74,-.2],e,!1,!1),F(P.sideSkirt,N.playerAccent,[-.72,.34,0],e,!1,!1),F(P.sideSkirt,N.playerAccent,[.72,.34,0],e,!1,!1),F(P.playerCabin,N.black,[0,.88,-.05],e,!1,!1),F(P.roofScoop,N.playerAccent,[0,1.2,-.18],e,!1,!1);let t=F(P.windshield,N.glass,[0,.96,-.24],e,!1,!1);t.rotation.x=.35;let n=F(P.rearGlass,N.glass,[0,.98,.44],e,!1,!1);return n.rotation.x=-.25,F(P.mirror,N.black,[-.76,.84,.28],e,!1,!1),F(P.mirror,N.black,[.76,.84,.28],e,!1,!1),F(P.bumper,N.chrome,[0,.41,1.18],e,!1,!1),F(P.bumper,N.chrome,[0,.41,-1.18],e,!1,!1),F(P.grille,N.grille,[0,.5,-1.25],e,!1,!1),F(P.plate,N.plate,[0,.34,1.31],e,!1,!1),F(P.plate,N.plate,[0,.34,-1.31],e,!1,!1),F(P.spoiler,N.playerAccent,[0,.95,1.02],e,!1,!1),F(P.exhaust,N.chrome,[-.38,.23,1.33],e,!1,!1),F(P.exhaust,N.chrome,[.38,.23,1.33],e,!1,!1),F(P.headlight,N.headlight,[-.36,.5,-1.18],e,!1,!1),F(P.headlight,N.headlight,[.36,.5,-1.18],e,!1,!1),F(P.headlightBeam,N.headlightGlow,[-.36,.17,-2.28],e,!1,!1),F(P.headlightBeam,N.headlightGlow,[.36,.17,-2.28],e,!1,!1),[-.36,.36].forEach(t=>{let n=F(P.headlightReflection,N.headlightReflection,[t,.065,-2.65],e,!1,!1);n.renderOrder=4,Oe.push(n)}),F(P.taillight,N.taillight,[-.34,.5,1.18],e,!1,!1),F(P.taillight,N.taillight,[.34,.5,1.18],e,!1,!1),[[-.75,.24,.78],[.75,.24,.78],[-.75,.24,-.78],[.75,.24,-.78]].forEach(([t,n,r])=>{De(e,t,n,r)}),e.position.set(0,0,Tl),e.userData.halfW=.72,e.userData.halfZ=1.15,e}let I=ke();b.add(I);let Ae=[2450411,16096779,1096065,9133302,16007006].map(e=>new Ri({color:e,roughness:.16,metalness:.38,clearcoat:.95,clearcoatRoughness:.04,reflectivity:.92,envMapIntensity:1.55}));Ae.forEach(e=>ue(e,`paint`,.035));function je(e=-40){let t=new Dn;le(t,P.contactShadowObstacle,.2);let n=Ae[Math.floor(Math.random()*Ae.length)];return F(P.obstacleBody,n,[0,.43,0],t,!1,!1),F(P.hoodStripe,N.black,[0,.66,.08],t,!1,!1).scale.set(.72,.75,.8),F(P.obstacleCabin,N.black,[0,.83,0],t,!1,!1),F(P.obstacleGlass,N.glass,[0,.9,.05],t,!1,!1),F(P.bumper,N.chrome,[0,.38,1.05],t,!1,!1).scale.set(.9,.85,.8),F(P.bumper,N.chrome,[0,.38,-1.05],t,!1,!1).scale.set(.9,.85,.8),F(P.grille,N.grille,[0,.48,1.09],t,!1,!1).scale.set(.72,.7,.8),F(P.headlight,N.headlight,[-.32,.48,1.08],t,!1,!1).scale.set(.82,.82,.82),F(P.headlight,N.headlight,[.32,.48,1.08],t,!1,!1).scale.set(.82,.82,.82),F(P.taillight,N.taillight,[-.32,.47,-1.08],t,!1,!1).scale.set(.8,.8,.8),F(P.taillight,N.taillight,[.32,.47,-1.08],t,!1,!1).scale.set(.8,.8,.8),F(P.mirror,N.black,[-.7,.78,.2],t,!1,!1).scale.set(.75,.75,.75),F(P.mirror,N.black,[.7,.78,.2],t,!1,!1).scale.set(.75,.75,.75),[[-.72,.22,.7],[.72,.22,.7],[-.72,.22,-.7],[.72,.22,-.7]].forEach(([e,n,r])=>{De(t,e,n,r,P.obstacleWheel)}),t.position.set(wl[Math.floor(Math.random()*wl.length)],0,e),t.userData.passed=!1,t.userData.halfW=.68,t.userData.halfZ=1.05,b.add(t),t}r.obstacles=[je(-38),je(-62),je(-86)];let Me=new En;function L(e,t){let n=e===`rain`,r=new di(n?P.rainStreak:P.snowFlake,n?N.rainStreak:N.snowFlake,t);r.instanceMatrix.setUsage(ot),r.frustumCulled=!1,r.visible=!1,b.add(r);let i=Array.from({length:t},()=>({x:-12+Math.random()*24,y:1.2+Math.random()*11,z:-88+Math.random()*100,speed:.65+Math.random()*.75,phase:Math.random()*Math.PI*2,scale:.65+Math.random()*.75}));return i.forEach((e,t)=>{Me.position.set(e.x,e.y,e.z),Me.rotation.set(n?-.18:0,0,n?-.12:0),Me.scale.setScalar(e.scale),Me.updateMatrix(),r.setMatrixAt(t,Me.matrix)}),r.instanceMatrix.needsUpdate=!0,{mesh:r,particles:i,type:e}}let Ne={rain:L(`rain`,_?100:220),snow:L(`snow`,_?80:160)};function R(e,t){e.x=-12+Math.random()*24,e.y=7+Math.random()*7,e.z=t===`rain`?-86+Math.random()*74:-92+Math.random()*88,e.speed=t===`rain`?.65+Math.random()*.75:.35+Math.random()*.55,e.phase=Math.random()*Math.PI*2,e.scale=t===`rain`?.72+Math.random()*.7:.65+Math.random()*.9}function z(e,t,n,r,i){if(e.mesh.visible=t>.035,e.mesh.material.opacity=e.type===`rain`?t*.34:t*.78,!e.mesh.visible)return;let a=e.type===`rain`,o=a?r*.72:r*.32;for(let r=0;r<e.particles.length;r++){let s=e.particles[r];a?(s.y-=(.42+s.speed*.3)*n,s.x-=.018*n,s.z+=o):(s.y-=(.035+s.speed*.028)*n,s.x+=Math.sin(i*1.2+s.phase)*.012*n,s.z+=o),(s.y<.18||s.z>12||s.x<-14||s.x>14)&&R(s,e.type),Me.position.set(s.x,s.y,s.z),a?(Me.rotation.set(-.24,0,-.12),Me.scale.set(.72,s.scale*(.82+t*.52),.72)):(Me.rotation.set(i*.35+s.phase,i*.22+s.phase,i*.18),Me.scale.setScalar(s.scale)),Me.updateMatrix(),e.mesh.setMatrixAt(r,Me.matrix)}e.mesh.instanceMatrix.needsUpdate=!0}let B={skyTop:new K,skyHorizon:new K,skyHaze:new K,fogColor:new K,sunColor:new K,gradeTint:new K,sunPosition:new W,sunDirection:new W,fogNear:zl.clear_noon.fogNear,fogFar:zl.clear_noon.fogFar,sunIntensity:zl.clear_noon.sunIntensity,ambientIntensity:zl.clear_noon.ambientIntensity,hemiIntensity:zl.clear_noon.hemiIntensity,fillIntensity:zl.clear_noon.fillIntensity,rimIntensity:zl.clear_noon.rimIntensity,bloomStrength:zl.clear_noon.bloomStrength,bloomThreshold:zl.clear_noon.bloomThreshold,exposure:zl.clear_noon.exposure,saturation:zl.clear_noon.saturation,contrast:zl.clear_noon.contrast,roadWetness:0,snowCover:0,rainAmount:0,snowAmount:0,thunderAmount:0,cloudOpacity:zl.clear_noon.cloudOpacity,lampIntensity:zl.clear_noon.lampIntensity,lampGlowOpacity:zl.clear_noon.lampGlowOpacity,headlightBoost:zl.clear_noon.headlightBoost,lightningFlash:0};function Pe(e){let t=r.weatherState;t.elapsed+=e;let n=t.elapsed%(43*Rl.length),i=Math.floor(n/43),a=n-i*43,o=Rl[i],s=Rl[(i+1)%Rl.length],c=a<=Il?0:Hl((a-Il)/Ll),l=zl[o],u=zl[s];return t.fromPreset=o,t.toPreset=s,t.transitionProgress=c,B.skyTop.copy(l.skyTop).lerp(u.skyTop,c),B.skyHorizon.copy(l.skyHorizon).lerp(u.skyHorizon,c),B.skyHaze.copy(l.skyHaze).lerp(u.skyHaze,c),B.fogColor.copy(l.fogColor).lerp(u.fogColor,c),B.sunColor.copy(l.sunColor).lerp(u.sunColor,c),B.gradeTint.copy(l.gradeTint).lerp(u.gradeTint,c),B.sunPosition.copy(l.sunPosition).lerp(u.sunPosition,c),B.sunDirection.copy(l.sunDirection).lerp(u.sunDirection,c).normalize(),B.fogNear=$(l.fogNear,u.fogNear,c),B.fogFar=$(l.fogFar,u.fogFar,c),B.sunIntensity=$(l.sunIntensity,u.sunIntensity,c),B.ambientIntensity=$(l.ambientIntensity,u.ambientIntensity,c),B.hemiIntensity=$(l.hemiIntensity,u.hemiIntensity,c),B.fillIntensity=$(l.fillIntensity,u.fillIntensity,c),B.rimIntensity=$(l.rimIntensity,u.rimIntensity,c),B.bloomStrength=$(l.bloomStrength,u.bloomStrength,c),B.bloomThreshold=$(l.bloomThreshold,u.bloomThreshold,c),B.exposure=$(l.exposure,u.exposure,c),B.saturation=$(l.saturation,u.saturation,c),B.contrast=$(l.contrast,u.contrast,c),B.roadWetness=$(l.roadWetness,u.roadWetness,c),B.snowCover=$(l.snowCover,u.snowCover,c),B.rainAmount=$(l.rainAmount,u.rainAmount,c),B.snowAmount=$(l.snowAmount,u.snowAmount,c),B.thunderAmount=$(l.thunderAmount,u.thunderAmount,c),B.cloudOpacity=$(l.cloudOpacity,u.cloudOpacity,c),B.lampIntensity=$(l.lampIntensity,u.lampIntensity,c),B.lampGlowOpacity=$(l.lampGlowOpacity,u.lampGlowOpacity,c),B.headlightBoost=$(l.headlightBoost,u.headlightBoost,c),B.thunderAmount>.18?(t.lightningCooldown-=e*(.8+B.thunderAmount*.6),t.lightningCooldown<=0&&(t.lightningFlash=1,t.lightningCooldown=2.6+Math.random()*5.4,t.lightningX=-22+Math.random()*44)):t.lightningCooldown=Math.max(t.lightningCooldown,3.8),t.lightningFlash=Math.max(0,t.lightningFlash-e*3.6),B.lightningFlash=t.lightningFlash*B.thunderAmount,B}function Fe(e,t,n){let r=ce.get(e);r&&e.color.copy(r).lerp(t,n)}let Ie=new K,Le=new K,Re=new K,ze=new K(10336466),Be=new K(9417168),Ve=new K(11125727),He=new K(13161951),Ue=new K(9413034);function We(e,t){let n=e.lightningFlash,i=Math.max(e.roadWetness,e.rainAmount*.65,e.thunderAmount*.85),a=Math.max(.22,i);Ie.copy(e.skyTop).lerp(e.skyHorizon,.24+n*.18),b.background.copy(Ie),b.fog.color.copy(e.fogColor).lerp(ze,n*.22),b.fog.near=Math.max(8,e.fogNear-n*3),b.fog.far=e.fogFar+n*14,N.sky.uniforms.uZenith.value.copy(e.skyTop),N.sky.uniforms.uHorizon.value.copy(e.skyHorizon),N.sky.uniforms.uHaze.value.copy(e.skyHaze),N.sky.uniforms.uSunColor.value.copy(e.sunColor),N.sky.uniforms.uLightning.value=n,ae.skySunDirection.value.copy(e.sunDirection),ae.roadWetness.value=e.roadWetness,ae.snowCover.value=e.snowCover,S.toneMappingExposure=e.exposure+n*.045,te.intensity=e.ambientIntensity+n*.045,ne.intensity=e.hemiIntensity+n*.08,Le.copy(e.skyHorizon).lerp(Be,e.snowCover*.22+n*.2),Re.set(3428144).lerp(Ue,e.snowCover*.42),ne.color.copy(Le),ne.groundColor.copy(Re),re.color.copy(e.sunColor).lerp(Ve,n*.65),re.intensity=e.sunIntensity+n*2.1,re.position.copy(e.sunPosition),A.intensity=e.fillIntensity+n*.2,ie.intensity=e.rimIntensity+n*.8,ie.color.copy(e.skyHaze).lerp(He,.14+n*.4),j.position.set(r.weatherState.lightningX,18,-42),j.intensity=n*4.8,j.distance=95,pe.position.set(e.sunPosition.x*1.18,e.sunPosition.y+1.5,e.sunPosition.z*1.55),pe.visible=e.sunIntensity>.45&&e.thunderAmount<.75,N.sunBlock.color.copy(e.sunColor),N.cloud.opacity=e.cloudOpacity,N.lampHead.emissiveIntensity=e.lampIntensity,N.lampGlow.opacity=e.lampGlowOpacity*a,N.headlight.emissiveIntensity=.12+e.headlightBoost*.92,N.taillight.emissiveIntensity=.5+e.headlightBoost*.5,N.reflector.emissiveIntensity=.05+e.headlightBoost*.42,N.headlightGlow.opacity=i*(.012+e.headlightBoost*.052),N.headlightReflection.opacity=e.roadWetness*(.006+e.headlightBoost*.04),N.puddle.opacity=e.roadWetness*(.08+e.rainAmount*.055),he.forEach(e=>{e.visible=N.puddle.opacity>.025}),N.road.roughness=$(.82,.22,e.roadWetness),N.roadPatch.roughness=$(.86,.2,e.roadWetness),N.shoulder.roughness=$(.95,.48,e.roadWetness),N.shoulderLight.roughness=$(.96,.52,e.roadWetness),N.road.envMapIntensity=.9+e.roadWetness*.85,N.roadPatch.envMapIntensity=1.05+e.roadWetness*1.1,N.playerBody.envMapIntensity=1.2+e.roadWetness*.46+e.thunderAmount*.14,N.playerAccent.envMapIntensity=1.05+e.roadWetness*.32,N.glass.envMapIntensity=1.3+e.roadWetness*.44,N.chrome.envMapIntensity=1.18+e.roadWetness*.42,N.rim.envMapIntensity=1.35+e.roadWetness*.38,Fe(N.ground,oe,e.snowCover*.34),Fe(N.grassDark,oe,e.snowCover*.38),Fe(N.grassLight,oe,e.snowCover*.34),Fe(N.field,oe,e.snowCover*.32),Fe(N.crop,oe,e.snowCover*.24),Fe(N.leaves,oe,e.snowCover*.3),Fe(N.leavesDark,oe,e.snowCover*.34),Fe(N.bush,oe,e.snowCover*.28),Fe(N.mountain,se,e.snowCover*.28),Fe(N.barrier,oe,e.snowCover*.08),Fe(N.barrierTop,oe,e.snowCover*.08),Fe(N.shoulder,oe,e.snowCover*.12),Fe(N.shoulderLight,oe,e.snowCover*.1),Fe(N.sidewalk,oe,e.snowCover*.12),Fe(N.curb,oe,e.snowCover*.1),Fe(N.cityWall,oe,e.snowCover*.08),Fe(N.cityWallCool,oe,e.snowCover*.08),Fe(N.cityDarkWall,oe,e.snowCover*.06),Fe(N.planter,oe,e.snowCover*.08),Xe&&Ze&&(Xe.strength=e.bloomStrength+a*.035+i*t*.024+n*.24,Xe.radius=.42+a*.12,Xe.threshold=Math.max(.68,e.bloomThreshold-a*.035),Ze.uniforms.uTint.value.set(e.gradeTint.r,e.gradeTint.g,e.gradeTint.b),Ze.uniforms.uSaturation.value=e.saturation,Ze.uniforms.uContrast.value=e.contrast)}function Ge(){r.started=!0,r.gameOver=!1,r.score=0,r.speed=Ol,r.lane=1,r.targetX=0,r.lastUiScore=-1,r.lastUiSpeed=-1,I.position.set(0,0,Tl),I.rotation.set(0,0,0),r.obstacles.forEach((e,t)=>{e.position.z=-38-t*24,e.position.x=wl[Math.floor(Math.random()*wl.length)],e.userData.passed=!1}),i(0),o(Ul(Ol)),c(!1),f(!1),u(!0)}r.resetGame=Ge;function Ke(e){!r.started||r.gameOver||(r.lane=Vl(r.lane+e,0,wl.length-1),r.targetX=wl[r.lane])}r.moveLane=Ke;let qe=e=>{let t=e.key.toLowerCase();[`arrowleft`,`a`].includes(t)&&Ke(-1),[`arrowright`,`d`].includes(t)&&Ke(1),[` `,`enter`].includes(t)&&(!r.started||r.gameOver)&&Ge()};window.addEventListener(`keydown`,qe,{passive:!0});let Je=null;function Ye(e,t){return Math.abs(e.position.x-t.position.x)<e.userData.halfW+t.userData.halfW&&Math.abs(e.position.z-t.position.z)<e.userData.halfZ+t.userData.halfZ}let Xe=null,Ze=null;{let e=new yl(b,x);Xe=new xl(new U(t.clientWidth,t.clientHeight),zl.clear_noon.bloomStrength,.5,zl.clear_noon.bloomThreshold),Ze=new pl(Bl),Ze.uniforms.uGrain.value=0,Ze.uniforms.uVignette.value=1.18,Ze.uniforms.uChromatic.value=.0016,Ze.uniforms.uSaturation.value=zl.clear_noon.saturation,Ze.uniforms.uContrast.value=zl.clear_noon.contrast,O=new gl(S),O.addPass(e),O.addPass(Xe),O.addPass(Ze),O.addPass(new vl)}k();let Qe=0,$e=_?12:6;function tt(){r.animationId=requestAnimationFrame(tt);let e=performance.now(),t=Math.min((e-a)/1e3,.033);a=e;let n=t*60;if(l+=t*1e3,d+=1,d>=120&&e-p>1500){let t=l/d,n=t>Ml?Math.max(v,s-.08):t<14?Math.min(1,s+.04):s;Math.abs(n-s)>.001&&(s=n,k(),p=e),l=0,d=0}let u=r.started&&!r.gameOver,m=(u?r.speed:.012)*n,h=e*.001,g=Pe(t);for(let e=0;e<r.animatedRoadItems.length;e++){let t=r.animatedRoadItems[e];t.object.position.z+=m*t.speedMul,t.object.position.z>t.resetAfter&&(t.object.position.z-=t.resetBy)}z(Ne.rain,g.rainAmount,n,m,h),z(Ne.snow,g.snowAmount,n,m,h);let _=(u?r.speed*2.8:.025)*n;for(let e=0;e<r.wheelGroups.length;e++)r.wheelGroups[e].rotation.x-=_;if(u){r.score+=.2*n,r.speed=Math.min(kl,Ol+r.score/2400);let t=Math.floor(r.score);t!==r.lastUiScore&&(r.lastUiScore=t,i(t));let a=Ul(r.speed);a!==r.lastUiSpeed&&(r.lastUiSpeed=a,o(a));let s=r.targetX-I.position.x;I.position.x+=s*Math.min(1,.16*n),Math.abs(s)<.002&&(I.position.x=r.targetX),I.position.y=Math.sin(e*.013)*.015;let l=r.targetX-I.position.x;I.rotation.z=l*-.06,I.rotation.y=l*-.04;for(let e=0;e<r.obstacles.length;e++){let t=r.obstacles[e];if(t.position.z+=r.speed*n,!t.userData.passed&&t.position.z>I.position.z&&(t.userData.passed=!0,r.score+=25),t.position.z>14&&(t.position.z=-76-Math.random()*34,t.position.x=wl[Math.floor(Math.random()*wl.length)],t.userData.passed=!1),Ye(I,t)){r.gameOver=!0,c(!0),f(!0),Je&&window.clearTimeout(Je),Je=window.setTimeout(()=>f(!1),180);break}}}else I.rotation.z*=.92,I.rotation.y*=.92;let y=u?58+r.speed*6:58;x.fov+=(y-x.fov)*.08*n,x.updateProjectionMatrix();let C=(r.speed-Ol)/(kl-Ol);We(g,C);let w=x.aspect<.8?Fl:0,T=I.position.x,D=T-x.position.x;x.position.x+=D*.08*n,Math.abs(D)<.002&&(x.position.x=T),x.position.y+=(Nl-C*.04-x.position.y)*.035*n,x.position.z+=(Pl+w-C*.2-x.position.z)*.035*n,x.lookAt(T,.72+C*.04,1.62-C*.24),ae.time.value=h,ae.speed.value=C,Xe&&Ze&&(Ze.uniforms.uTime.value=h,Ze.uniforms.uSpeed.value=C),Qe+=1,Qe%$e===0&&(E.position.copy(I.position),E.position.y+=.72,I.visible=!1,E.update(S,b),I.visible=!0),O?O.render():S.render(b,x)}tt();let nt=null,rt=()=>{nt||=requestAnimationFrame(()=>{nt=null,t&&(x.aspect=t.clientWidth/t.clientHeight,x.updateProjectionMatrix(),Xe&&Xe.resolution.set(t.clientWidth,t.clientHeight),k())})};return window.addEventListener(`resize`,rt,{passive:!0}),()=>{cancelAnimationFrame(r.animationId),nt&&cancelAnimationFrame(nt),Je&&window.clearTimeout(Je),window.removeEventListener(`keydown`,qe),window.removeEventListener(`resize`,rt),t.contains(S.domElement)&&t.removeChild(S.domElement),O&&O.dispose(),w.dispose(),T.dispose(),C.dispose(),b.environment=null,b.traverse(e=>{e.material&&!Object.values(N).includes(e.material)&&!Ae.includes(e.material)&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),S.dispose(),Object.values(P).forEach(e=>e.dispose()),Object.values(N).forEach(e=>e.dispose()),Ae.forEach(e=>e.dispose()),r.obstacles=[],r.animatedRoadItems=[],r.wheelGroups=[],r.moveLane=null,r.weatherState=null}},[]);let p=()=>n.current.resetGame?.(),m=e=>n.current.moveLane?.(e),h=e=>t=>{t.preventDefault(),t.stopPropagation(),m(e)},g=e=>{e.pointerType!==`mouse`&&(t.current=e.clientX)},v=e=>{if(e.pointerType===`mouse`||t.current===null)return;let n=e.clientX-t.current;t.current=null,Math.abs(n)>36&&m(n>0?1:-1)},y=Vl((a-Al)/(jl-Al),0,1),b=Math.round(y*260),x={background:`conic-gradient(from -130deg, #22d3ee 0deg, #facc15 ${b}deg, rgba(255,255,255,0.16) ${b}deg 260deg, transparent 260deg 360deg)`},S=s?`RETRY`:l?`RESET`:`START`;return(0,Q.jsx)(`div`,{className:`relative min-h-screen w-full overflow-hidden bg-[#06101d] text-white`,style:{minHeight:`100vh`,height:`100dvh`},children:(0,Q.jsxs)(`div`,{className:`relative h-[100svh] min-h-[540px] w-full overflow-hidden bg-slate-900 touch-none select-none`,style:{minHeight:540,height:`100dvh`,width:`100%`},onPointerDown:g,onPointerUp:v,children:[(0,Q.jsx)(`div`,{ref:e,className:`h-full w-full`,style:{height:`100%`,width:`100%`}}),(0,Q.jsxs)(`div`,{className:`pointer-events-none absolute left-3 right-3 top-3 z-20 flex items-start justify-between gap-3 sm:left-6 sm:right-6 sm:top-6`,children:[(0,Q.jsxs)(`div`,{className:`flex items-start gap-2 sm:gap-3`,children:[(0,Q.jsxs)(`div`,{className:`min-w-24 rounded-lg border border-white/15 bg-slate-950/70 px-3 py-2 shadow-xl backdrop-blur-md sm:min-w-28`,children:[(0,Q.jsx)(`div`,{className:`text-[10px] font-semibold uppercase text-cyan-200`,children:`Score`}),(0,Q.jsx)(`div`,{className:`text-2xl font-black leading-none tabular-nums sm:text-3xl`,children:r})]}),(0,Q.jsxs)(`div`,{className:`relative h-20 w-20 rounded-full border border-white/15 bg-slate-950/70 shadow-xl backdrop-blur-md sm:h-24 sm:w-24`,children:[(0,Q.jsx)(`div`,{className:`absolute inset-1 rounded-full`,style:x}),(0,Q.jsx)(`div`,{className:`absolute inset-3 rounded-full bg-slate-950/95 shadow-inner`}),(0,Q.jsx)(`div`,{className:`absolute left-1/2 top-1/2 h-[2px] w-[31%] origin-left rounded-full bg-amber-200 shadow-[0_0_12px_rgba(250,204,21,0.8)]`,style:{transform:`rotate(${-130+y*260}deg)`}}),(0,Q.jsx)(`div`,{className:`absolute inset-0 grid place-items-center text-center`,children:(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`div`,{className:`text-xl font-black leading-none tabular-nums sm:text-2xl`,children:a}),(0,Q.jsx)(`div`,{className:`text-[9px] font-semibold uppercase text-slate-300`,children:`km/h`})]})})]})]}),(0,Q.jsx)(`button`,{onClick:p,className:`pointer-events-auto rounded-lg border border-white/20 bg-white px-4 py-3 text-sm font-black text-slate-950 shadow-xl transition hover:bg-cyan-100 active:scale-95 sm:px-5`,children:S})]}),!l&&(0,Q.jsx)(`div`,{className:`absolute inset-0 z-10 grid place-items-center bg-slate-950/30 p-5 backdrop-blur-[2px]`,children:(0,Q.jsxs)(`div`,{className:`w-full max-w-xs rounded-lg border border-white/15 bg-slate-950/78 p-5 text-center shadow-2xl backdrop-blur-md`,children:[(0,Q.jsx)(`div`,{className:`mb-4 h-1.5 rounded-full bg-gradient-to-r from-cyan-300 via-amber-300 to-red-400`}),(0,Q.jsx)(`button`,{onClick:e=>{e.stopPropagation(),p()},className:`w-full rounded-lg bg-white px-6 py-4 text-lg font-black text-slate-950 shadow-xl transition hover:bg-cyan-100 active:scale-95`,children:`START RUN`}),(0,Q.jsxs)(`div`,{className:`mt-4 flex justify-center gap-2 text-xs font-semibold text-slate-300`,children:[(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1`,children:`A`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1`,children:`D`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1`,children:`SWIPE`})]})]})}),s&&(0,Q.jsx)(`div`,{className:`absolute inset-0 z-10 grid place-items-center bg-red-950/28 p-5 backdrop-blur-[2px]`,children:(0,Q.jsxs)(`div`,{className:`w-full max-w-xs rounded-lg border border-red-300/25 bg-slate-950/84 p-5 text-center shadow-2xl backdrop-blur-md`,children:[(0,Q.jsx)(`div`,{className:`text-xs font-black uppercase text-red-200`,children:`Crash`}),(0,Q.jsx)(`div`,{className:`mt-1 text-5xl font-black leading-none tabular-nums`,children:r}),(0,Q.jsx)(`button`,{onClick:e=>{e.stopPropagation(),p()},className:`mt-5 w-full rounded-lg bg-white px-6 py-4 text-base font-black text-slate-950 shadow-xl transition hover:bg-red-100 active:scale-95`,children:`RETRY`})]})}),d&&(0,Q.jsx)(`div`,{className:`pointer-events-none absolute inset-0 z-30 bg-white/30`}),(0,Q.jsxs)(`div`,{className:`pointer-events-none absolute bottom-5 left-5 z-20 hidden items-center gap-2 rounded-lg border border-white/10 bg-slate-950/64 px-3 py-2 text-xs font-semibold text-slate-300 backdrop-blur-md sm:flex`,children:[(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1 text-white`,children:`A`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1 text-white`,children:`D`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1 text-white`,children:`←`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1 text-white`,children:`→`}),(0,Q.jsx)(`span`,{className:`rounded-md border border-white/15 bg-white/10 px-2 py-1 text-white`,children:`SPACE`})]}),l&&!s&&(0,Q.jsxs)(`div`,{className:`absolute inset-x-0 bottom-5 z-20 flex items-end justify-between px-5 sm:hidden`,children:[(0,Q.jsxs)(`div`,{className:`flex gap-3`,children:[(0,Q.jsx)(`button`,{"aria-label":`Move left`,onPointerDown:h(-1),className:`h-16 w-16 rounded-lg border border-white/18 bg-slate-950/70 text-4xl font-black text-white shadow-xl backdrop-blur-md active:scale-95`,children:`‹`}),(0,Q.jsx)(`button`,{"aria-label":`Move right`,onPointerDown:h(1),className:`h-16 w-16 rounded-lg border border-white/18 bg-slate-950/70 text-4xl font-black text-white shadow-xl backdrop-blur-md active:scale-95`,children:`›`})]}),(0,Q.jsx)(`button`,{onPointerDown:e=>{e.preventDefault(),e.stopPropagation(),p()},className:`h-14 rounded-lg border border-white/18 bg-white/90 px-5 text-xs font-black text-slate-950 shadow-xl backdrop-blur-md active:scale-95`,children:`RESET`})]})]})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(_.StrictMode,{children:(0,Q.jsx)(Wl,{})}));
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(e,t,n){let r=new Float32Array(no),i=new W(0,1,0);return new Pi({name:`SphericalGaussianBlur`,defines:{n:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:bo(),fragmentShader:`
	...
	`}var xo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};xl.BlurDirectionX=new U(1,0),xl.BlurDirectionY=new U(0,1);var Sl=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=o(((e,t)=>{t.exports=Sl()}))(),Cl=[-2.55,0,2.55],wl=3.2,Tl=18,El=116,Dl=.18,Ol=.52,kl=68,Al=224,jl=18.5,Ml=6.65,Nl=12.35,Pl=1.25,Fl={uniforms:{tDiffuse:{value:null},uTime:{value:0},uSpeed:{value:0},uGrain:{value:.028},uVignette:{value:1.18},uChromatic:{value:.0016}},vertexShader:`
    varying vec2 vUv;
  ...
  `};function Il(e,t,n){return Math.min(n,Math.max(t,e))}function Ll(e){let t=(e-Dl)/(Ol-Dl);return Math.round(kl+Il(t,0,1)*(Al-kl))}function Rl(){let e=(0,_.useRef)(null),t=(0,_.useRef)(null),n=(0,_.useRef)({started:!1,gameOver:!1,score:0,speed:Dl,lane:1,targetX:0,obstacles:[],animatedRoadItems:[],wheelGroups:[],animationId:null,resetGame:null,moveLane:null,lastUiScore:-1,lastUiSpeed:-1}),[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(Ll(Dl)),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let t=e.current;if(!t)return;let r=n.current;r.animatedRoadItems=[],r.obstacles=[],r.wheelGroups=[];let a=performance.now(),s=1,l=0,d=0,p=performance.now(),m=window.matchMedia(`(pointer: coarse)`).matches,h=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,g=navigator.hardwareConcurrency||8,_=navigator.deviceMemory||8,v=m||g<=4||_<=4,y=!v&&!h,b=v?.68:.76,x=v?1:1.3,S=new Pn;S.background=new q(9425151),S.fog=new Nn(11132159,34,132);let C=new ha(60,t.clientWidth/t.clientHeight,.1,200);C.position.set(0,Ml,Nl+(t.clientWidth<700?Pl:0)),C.lookAt(0,1.05,-5.6);let w=new al({antialias:!v,powerPreference:`high-performance`});w.outputColorSpace=et,w.toneMapping=4,w.toneMappingExposure=.98,w.shadowMap.enabled=!1,w.domElement.style.touchAction=`none`,t.appendChild(w.domElement);let T=new fo(w),E=T.fromScene(new ol,.04).texture;S.environment=E;let D=null,O=new U;function ee(){if(!t)return;let e=Math.min(window.devicePixelRatio||1,x*s);O.set(t.clientWidth,t.clientHeight),w.setPixelRatio(e),w.setSize(O.x,O.y,!1),D&&(D.setPixelRatio(e),D.setSize(O.x,O.y))}ee();let k=new Ca(16777215,.22);S.add(k);let te=new ra(13233407,3428144,.84);S.add(te);let ne=new Sa(16772543,2.55);ne.position.set(-15,22,13),ne.castShadow=!0,ne.shadow.mapSize.set(v?512:1024,v?512:1024),ne.shadow.camera.left=-26,ne.shadow.camera.right=26,ne.shadow.camera.top=26,ne.shadow.camera.bottom=-26,ne.shadow.camera.near=1,ne.shadow.camera.far=70,ne.shadow.bias=-12e-5,S.add(ne);let re=new Sa(9558015,.28);re.position.set(8,6,12),S.add(re);let A=new Sa(15661311,.58);A.position.set(0,4,-12),S.add(A);let j=new Tn;S.add(j);let M={time:{value:0},speed:{value:0},skySunDirection:{value:new W(-.5,.72,.22).normalize()}},N={sky:new Pi({side:1,depthWrite:!1,depthTest:!1,uniforms:{uTime:M.time,uSunDirection:M.skySunDirection,uZenith:{value:new q(6272255)},uHorizon:{value:new q(13036543)},uHaze:{value:new q(15661311)},uSunColor:{value:new q(16763238)}},vertexShader:`
          varying vec3 vWorldPosition;
        ...
        `}),ground:new Y({color:5154906,roughness:1}),grassDark:new Y({color:4165449,roughness:1}),grassLight:new Y({color:7518045,roughness:1}),field:new Y({color:9418843,roughness:1}),crop:new Y({color:13678682,roughness:.96}),road:new Y({color:2501941,roughness:.92,metalness:.02}),roadPatch:new Y({color:3423044,roughness:.95,metalness:.01}),tireMark:new zr({color:921878,transparent:!0,opacity:.22,depthWrite:!1}),shoulder:new Y({color:5133401,roughness:.95}),shoulderLight:new Y({color:6844533,roughness:.96}),laneLine:new zr({color:16316656}),edgeLine:new zr({color:16768887}),rumbleRed:new Y({color:13123391,roughness:.9}),rumbleWhite:new Y({color:16053486,roughness:.85}),barrier:new Y({color:13949148,roughness:.8}),barrierTop:new Y({color:10266285,roughness:.75,metalness:.08}),reflector:new Y({color:16768106,emissive:16752412,emissiveIntensity:.55,roughness:.25}),signPost:new Y({color:9082011,roughness:.45,metalness:.45}),signBoard:new Y({color:1931869,roughness:.65}),signBack:new Y({color:2634815,roughness:.7}),lampPost:new Y({color:6121586,roughness:.5,metalness:.35}),lampHead:new Y({color:16771235,emissive:16762967,emissiveIntensity:.9,roughness:.28}),lampGlow:new zr({color:16765818,transparent:!0,opacity:.12,blending:2,depthWrite:!1}),mountain:new Y({color:7636890,roughness:1}),mountainSnow:new Y({color:15136255,roughness:.85}),trunk:new Y({color:7029286,roughness:1}),leaves:new Y({color:2325051,roughness:1}),leavesDark:new Y({color:1400626,roughness:1}),bush:new Y({color:3050055,roughness:1}),flower:new Y({color:16240989,roughness:.8}),buildingWall:new Y({color:14140833,roughness:.9}),buildingRoof:new Y({color:10173745,roughness:.85}),window:new Y({color:9361407,emissive:2979238,emissiveIntensity:.14,roughness:.2,metalness:.15}),chimney:new Y({color:8212800,roughness:.9}),cloud:new zr({color:16120831,transparent:!0,opacity:.78,depthWrite:!1}),sunBlock:new zr({color:16765286}),playerBody:new Ii({color:15804997,roughness:.24,metalness:.48,clearcoat:1,clearcoatRoughness:.08}),playerAccent:new Ii({color:1185827,roughness:.32,metalness:.32,clearcoat:.8,clearcoatRoughness:.12}),black:new Y({color:1120295,roughness:.35,metalness:.18}),glass:new Ii({color:10476799,roughness:.04,metalness:.08,transparent:!0,opacity:.74,clearcoat:1,clearcoatRoughness:.04,transmission:.18,thickness:.22}),chrome:new Ii({color:14278115,roughness:.12,metalness:.92,clearcoat:.7,clearcoatRoughness:.08}),grille:new Y({color:724757,roughness:.55,metalness:.55}),plate:new zr({color:16774872}),wheel:new Y({color:1118481,roughness:.8}),rim:new Ii({color:12107976,roughness:.22,metalness:.92,clearcoat:.5,clearcoatRoughness:.08}),headlight:new Y({color:16773552,emissive:16768392,emissiveIntensity:.82,roughness:.18,metalness:.15}),headlightGlow:new zr({color:16771235,transparent:!0,opacity:.08,blending:2,depthWrite:!1}),taillight:new Y({color:16732240,emissive:16720418,emissiveIntensity:1.18,roughness:.2,metalness:.1}),contactShadow:new zr({color:0,transparent:!0,opacity:.24,depthWrite:!1})},P={sky:new Ti(145,36,18),ground:new J(150,.2,220),grassTile:new J(5.2,.05,5.2),fieldStrip:new J(5.8,.08,2.1),cropRow:new J(.12,.16,2.3),road:new J(8,.12,120),roadPatch:new J(1.35,.025,2.2),tireMark:new J(.12,.025,4.5),shoulder:new J(.4,.06,120),edgeLine:new J(.08,.035,4.8),rumble:new J(.34,.04,.7),laneLine:new J(.16,.03,2.6),barrier:new J(.45,.45,2.5),barrierTop:new J(.52,.12,2.45),reflector:new J(.08,.08,.16),signPost:new J(.12,1.9,.12),signBoard:new J(1.8,.8,.12),fencePost:new J(.14,.72,.14),fenceRail:new J(.12,.12,2.7),lampPole:new J(.12,3.1,.12),lampArm:new J(1,.1,.1),lampHead:new J(.36,.18,.28),lampHalo:new Ti(.42,10,8),mountain:new Ci(5,8,4),mountainSnow:new Ci(2.3,2.6,4),trunk:new Si(.12,.16,1.2,8),leaves:new Ci(.7,1.6,10),bush:new J(.7,.46,.7),flower:new J(.12,.18,.12),houseBody:new J(2.6,1.6,2.4),houseRoof:new Ci(1.9,1,4),window:new J(.42,.38,.04),chimney:new J(.32,.7,.32),cloudBlock:new J(1.4,.7,.7),sunBlock:new J(2.2,2.2,.08),carBody:new J(1.35,.42,2.3),carHood:new J(1.2,.18,.7),carRear:new J(1.15,.2,.55),playerCabin:new J(.95,.45,1.05),hoodStripe:new J(.18,.035,1.65),sideSkirt:new J(.12,.16,1.72),mirror:new J(.18,.12,.22),roofScoop:new J(.42,.14,.48),spoiler:new J(1.25,.1,.24),grille:new J(.7,.18,.08),plate:new J(.36,.16,.04),exhaust:new J(.18,.12,.26),headlightBeam:new J(.34,.02,2.6),windshield:new J(.86,.28,.35),rearGlass:new J(.82,.22,.28),bumper:new J(1.18,.14,.18),headlight:new J(.18,.1,.08),taillight:new J(.2,.1,.08),tire:new Si(.24,.24,.26,16),rim:new Si(.13,.13,.27,12),obstacleBody:new J(1.25,.42,2.05),obstacleCabin:new J(.85,.36,.85),obstacleGlass:new J(.75,.22,.6),obstacleWheel:new Si(.21,.21,.22,14),contactShadowPlayer:new wi(1.6,2.8),contactShadowObstacle:new wi(1.5,2.5)};function F(e,t,n,r=j,i=!1,a=!0){let o=new Zr(e,t);return o.position.set(n[0],n[1],n[2]),o.castShadow=i,o.receiveShadow=a,r.add(o),o}function ie(e,t,n=.22){let r=N.contactShadow.clone();r.opacity=n;let i=new Zr(t,r);return i.rotation.x=-Math.PI/2,i.position.y=.025,e.add(i),i}function ae(e,t,n=.06){e.onBeforeCompile=e=>{e.uniforms.uSurfaceTime=M.time,e.uniforms.uSurfaceSpeed=M.speed,e.vertexShader=e.vertexShader.replace(`#include <common>`,`
            #include <common>
            ...
            `)},e.customProgramCacheKey=()=>`blockrush-${t}-${n}`}function I(e,t=Tl,n=El,i=1.9){return r.animatedRoadItems.push({object:e,resetAfter:t,resetBy:n,speedMul:i}),e}[N.road,N.roadPatch,N.shoulder,N.shoulderLight].forEach(e=>ae(e,`road`,.08)),[N.ground,N.grassDark,N.grassLight,N.field,N.crop,N.leaves,N.leavesDark,N.bush].forEach(e=>ae(e,`grass`,.04)),ae(N.playerBody,`paint`,.03);let L=new Zr(P.sky,N.sky);L.frustumCulled=!1,L.renderOrder=-100,S.add(L),F(P.ground,N.ground,[0,-.18,-50]),F(P.road,N.road,[0,-.05,-40]),F(P.shoulder,N.shoulder,[-4.2,0,-40]),F(P.shoulder,N.shoulder,[4.2,0,-40]),F(P.sunBlock,N.sunBlock,[-19,12.5,-48],j,!1,!1);function oe(e,t,n,r=Tl,i=El,a=1.9){return I(F(e,t,n,j,!1,!1),r,i,a)}for(let e=-95;e<20;e+=6)[-1.35,1.35].forEach(t=>{oe(P.laneLine,N.laneLine,[t,.035,e])});for(let e=-98;e<22;e+=4.8)[-3.82,3.82].forEach(t=>{oe(P.edgeLine,N.edgeLine,[t,.04,e],22,124,1.9)});for(let e=-106;e<22;e+=5.6){let t=Cl[Math.floor(Math.random()*Cl.length)];if(oe(P.roadPatch,N.roadPatch,[t+(Math.random()-.5)*.55,.03,e],22,128,1.9),Math.random()>.45){let n=oe(P.tireMark,N.tireMark,[t+.34,.045,e-1.4],22,128,1.9);n.rotation.y=(Math.random()-.5)*.06}}for(let e=-100;e<25;e+=2.8)[-4.45,4.45].forEach((t,n)=>{let r=(Math.floor(e)+n)%2==0?N.rumbleWhite:N.rumbleRed,i=oe(P.rumble,r,[t,.035,e],22,124,1.9);i.rotation.y=Math.PI*.5});function se(e,t,n){let r=new Tn;F(P.barrier,N.barrier,[0,.22,0],r,!0,!0),F(P.barrierTop,N.barrierTop,[0,.52,0],r,!0,!0),F(P.reflector,N.reflector,[-n*.24,.45,-.64],r,!1,!1),F(P.reflector,N.reflector,[-n*.24,.45,.64],r,!1,!1),r.position.set(e,0,t),j.add(r),I(r,22,124,1.9)}for(let e=-100;e<25;e+=5)[-5.3,5.3].forEach(t=>{se(t,e,Math.sign(t))});function ce(e,t,n,r=1){let i=new Tn;[[-.8,0,0],[0,.2,0],[.88,.02,0],[.28,-.16,.15]].forEach(([e,t,n],r)=>{F(P.cloudBlock,N.cloud,[e,t,n],i,!1,!1).scale.setScalar(r===1?1.18:.82+r*.06)}),i.position.set(e,t,n),i.scale.setScalar(r),j.add(i),I(i,42,150,.28)}for(let e=0;e<7;e++)ce(-28+e*9+Math.random()*4,9+Math.random()*3,-35-e*16,.9+Math.random()*.5);function le(e,t,n){let r=new Tn,i=F(P.mountain,N.mountain,[0,3.8,0],r,!1,!0);i.scale.setScalar(n),i.rotation.y=Math.PI*.25;let a=F(P.mountainSnow,N.mountainSnow,[0,7*n,0],r,!1,!1);a.scale.setScalar(n*.52),a.rotation.y=Math.PI*.25,r.position.set(e,0,t),j.add(r),I(r,36,158,.55)}for(let e=0;e<15;e++)le((e%2==0?-1:1)*(26+Math.random()*16),-88-e*7-Math.random()*24,.7+Math.random()*.8);function ue(e,t){let n=new Tn;F(P.fencePost,N.barrier,[0,.36,-1.18],n,!0,!0),F(P.fencePost,N.barrier,[0,.36,1.18],n,!0,!0),F(P.fenceRail,N.barrierTop,[0,.55,0],n,!0,!0),n.position.set(e,0,t),j.add(n),I(n,24,128,1.65)}for(let e=-102;e<24;e+=8)[-7.1,7.1].forEach(t=>ue(t,e));function de(e,t){let n=new Tn;F(P.trunk,N.trunk,[0,.6,0],n,!0,!1),F(P.leaves,N.leavesDark,[0,1.55,0],n,!0,!1),F(P.leaves,N.leaves,[0,2.1,0],n,!0,!1).scale.setScalar(.82),F(P.bush,N.bush,[.45,.24,.15],n,!0,!0),n.position.set(e,0,t),n.scale.setScalar(.85+Math.random()*.65),j.add(n),I(n,24,132,1.7)}function fe(e,t){let n=new Tn;F(P.fieldStrip,N.field,[0,.02,0],n,!1,!0);for(let e=-2;e<=2;e++)F(P.cropRow,N.crop,[e*.48,.16,0],n,!0,!1);n.position.set(e,-.02,t),j.add(n),I(n,24,132,1.48)}function pe(e,t){let n=new Tn;F(P.signPost,N.signPost,[0,.95,0],n,!0,!0),F(P.signBoard,N.signBoard,[0,1.85,0],n,!0,!1),F(P.signBoard,N.signBack,[0,1.82,-.08],n,!0,!1).scale.set(.88,.7,.55),F(P.reflector,N.reflector,[-.52,1.98,.08],n,!1,!1),F(P.reflector,N.reflector,[.52,1.98,.08],n,!1,!1),n.position.set(e*6.8,0,t),n.rotation.y=e<0?.04:-.04,j.add(n),I(n,26,140,1.8)}function me(e,t){let n=new Tn;F(P.lampPole,N.lampPost,[0,1.55,0],n,!0,!0),F(P.lampArm,N.lampPost,[-e*.42,3.04,0],n,!0,!0),F(P.lampHead,N.lampHead,[-e*.94,2.98,0],n,!1,!1),F(P.lampHalo,N.lampGlow,[-e*.94,2.98,0],n,!1,!1),n.position.set(e*5.85,0,t),j.add(n),I(n,26,132,1.75)}function he(e,t,n){let r=new Tn;F(P.houseBody,N.buildingWall,[0,.8,0],r,!0,!0);let i=F(P.houseRoof,N.buildingRoof,[0,1.92,0],r,!0,!0);i.rotation.y=Math.PI*.25,F(P.window,N.window,[-.66,.92,1.22],r,!1,!1),F(P.window,N.window,[.66,.92,1.22],r,!1,!1),F(P.chimney,N.chimney,[.72,2.25,-.4],r,!0,!0),r.position.set(e*(15+n%3*3.4),0,t),r.rotation.y=e<0?.18:-.18,j.add(r),I(r,30,150,1.25)}for(let e=-106;e<24;e+=8)[-1,1].forEach(t=>{let n=8+Math.random()*7,r=oe(P.grassTile,Math.random()>.5?N.grassDark:N.grassLight,[t*n,-.055,e+(Math.random()-.5)*2.4],24,132,1.55);r.rotation.y=(Math.random()-.5)*.35});for(let e=-100;e<20;e+=10)de(-10-Math.random()*4,e+Math.random()*2),de(10+Math.random()*4,e+Math.random()*2);for(let e=-112;e<16;e+=18)fe(-18-Math.random()*5,e),fe(18+Math.random()*5,e+7);for(let e=-110;e<8;e+=28)pe(Math.random()>.5?-1:1,e+5),he(-1,e-2,Math.floor(Math.random()*5)),he(1,e-12,Math.floor(Math.random()*5));for(let e=-100;e<20;e+=18)me(-1,e),me(1,e+9);function ge(e,t,n,i,a=P.tire){let o=new Tn,s=new Zr(a,N.wheel);s.rotation.z=Math.PI/2,s.castShadow=!0,o.add(s);let c=new Zr(P.rim,N.rim);return c.rotation.z=Math.PI/2,o.add(c),o.position.set(t,n,i),e.add(o),r.wheelGroups.push(o),o}function _e(){let e=new Tn;ie(e,P.contactShadowPlayer,.24),F(P.carBody,N.playerBody,[0,.45,0],e,!0,!1),F(P.carHood,N.playerBody,[0,.62,.65],e,!0,!1),F(P.carRear,N.playerBody,[0,.62,-.75],e,!0,!1),F(P.hoodStripe,N.playerAccent,[0,.74,.2],e,!0,!1),F(P.sideSkirt,N.playerAccent,[-.72,.34,0],e,!0,!1),F(P.sideSkirt,N.playerAccent,[.72,.34,0],e,!0,!1),F(P.playerCabin,N.black,[0,.88,-.05],e,!0,!1),F(P.roofScoop,N.playerAccent,[0,1.2,.04],e,!0,!1);let t=F(P.windshield,N.glass,[0,.96,.22],e,!1,!1);t.rotation.x=-.35;let n=F(P.rearGlass,N.glass,[0,.98,-.42],e,!1,!1);return n.rotation.x=.25,F(P.mirror,N.black,[-.76,.84,.28],e,!0,!1),F(P.mirror,N.black,[.76,.84,.28],e,!0,!1),F(P.bumper,N.chrome,[0,.41,1.18],e,!1,!1),F(P.bumper,N.chrome,[0,.41,-1.18],e,!1,!1),F(P.grille,N.grille,[0,.5,1.25],e,!1,!1),F(P.plate,N.plate,[0,.34,1.31],e,!1,!1),F(P.plate,N.plate,[0,.34,-1.31],e,!1,!1),F(P.spoiler,N.playerAccent,[0,.95,-1.02],e,!0,!1),F(P.exhaust,N.chrome,[-.38,.23,-1.33],e,!1,!1),F(P.exhaust,N.chrome,[.38,.23,-1.33],e,!1,!1),F(P.headlight,N.headlight,[-.36,.5,1.18],e,!1,!1),F(P.headlight,N.headlight,[.36,.5,1.18],e,!1,!1),F(P.headlightBeam,N.headlightGlow,[-.36,.17,2.28],e,!1,!1),F(P.headlightBeam,N.headlightGlow,[.36,.17,2.28],e,!1,!1),v||[-.36,.36].forEach(t=>{let n=new _a(16769704,.9,14,Math.PI/8,.58,1.35);n.position.set(t,.54,1.16),n.target.position.set(t,.16,6.8),n.castShadow=!1,e.add(n),e.add(n.target)}),F(P.taillight,N.taillight,[-.34,.5,-1.18],e,!1,!1),F(P.taillight,N.taillight,[.34,.5,-1.18],e,!1,!1),[[-.75,.24,.78],[.75,.24,.78],[-.75,.24,-.78],[.75,.24,-.78]].forEach(([t,n,r])=>{ge(e,t,n,r)}),e.position.set(0,0,wl),e.userData.halfW=.72,e.userData.halfZ=1.15,e}let ve=_e();S.add(ve);let ye=[2450411,16096779,1096065,9133302,16007006].map(e=>new Ii({color:e,roughness:.28,metalness:.34,clearcoat:.72,clearcoatRoughness:.1}));ye.forEach(e=>ae(e,`paint`,.035));function be(e=-40){let t=new Tn;ie(t,P.contactShadowObstacle,.2);let n=ye[Math.floor(Math.random()*ye.length)];return F(P.obstacleBody,n,[0,.43,0],t,!0,!1),F(P.hoodStripe,N.black,[0,.66,.08],t,!0,!1).scale.set(.72,.75,.8),F(P.obstacleCabin,N.black,[0,.83,0],t,!0,!1),F(P.obstacleGlass,N.glass,[0,.9,.05],t,!1,!1),F(P.bumper,N.chrome,[0,.38,1.05],t,!1,!1).scale.set(.9,.85,.8),F(P.bumper,N.chrome,[0,.38,-1.05],t,!1,!1).scale.set(.9,.85,.8),F(P.grille,N.grille,[0,.48,1.09],t,!1,!1).scale.set(.72,.7,.8),F(P.headlight,N.headlight,[-.32,.48,1.08],t,!1,!1).scale.set(.82,.82,.82),F(P.headlight,N.headlight,[.32,.48,1.08],t,!1,!1).scale.set(.82,.82,.82),F(P.taillight,N.taillight,[-.32,.47,-1.08],t,!1,!1).scale.set(.8,.8,.8),F(P.taillight,N.taillight,[.32,.47,-1.08],t,!1,!1).scale.set(.8,.8,.8),F(P.mirror,N.black,[-.7,.78,.2],t,!0,!1).scale.set(.75,.75,.75),F(P.mirror,N.black,[.7,.78,.2],t,!0,!1).scale.set(.75,.75,.75),[[-.72,.22,.7],[.72,.22,.7],[-.72,.22,-.7],[.72,.22,-.7]].forEach(([e,n,r])=>{ge(t,e,n,r,P.obstacleWheel)}),t.position.set(Cl[Math.floor(Math.random()*Cl.length)],0,e),t.userData.passed=!1,t.userData.halfW=.68,t.userData.halfZ=1.05,S.add(t),t}r.obstacles=[be(-20),be(-38),be(-56)];function xe(){r.started=!0,r.gameOver=!1,r.score=0,r.speed=Dl,r.lane=1,r.targetX=0,r.lastUiScore=-1,r.lastUiSpeed=-1,ve.position.set(0,0,wl),ve.rotation.set(0,0,0),r.obstacles.forEach((e,t)=>{e.position.z=-22-t*18,e.position.x=Cl[Math.floor(Math.random()*Cl.length)],e.userData.passed=!1}),i(0),o(Ll(Dl)),c(!1),f(!1),u(!0)}r.resetGame=xe;function Se(e){!r.started||r.gameOver||(r.lane=Il(r.lane+e,0,Cl.length-1),r.targetX=Cl[r.lane])}r.moveLane=Se;let Ce=e=>{let t=e.key.toLowerCase();[`arrowleft`,`a`].includes(t)&&Se(-1),[`arrowright`,`d`].includes(t)&&Se(1),[` `,`enter`].includes(t)&&(!r.started||r.gameOver)&&xe()};window.addEventListener(`keydown`,Ce,{passive:!0});let we=null;function Te(e,t){return Math.abs(e.position.x-t.position.x)<e.userData.halfW+t.userData.halfW&&Math.abs(e.position.z-t.position.z)<e.userData.halfZ+t.userData.halfZ}let Ee=null,De=null;if(y){let e=new yl(S,C);Ee=new xl(new U(t.clientWidth,t.clientHeight),.1,.38,.95),De=new pl(Fl),De.uniforms.uGrain.value=.026,De.uniforms.uVignette.value=1.18,De.uniforms.uChromatic.value=.0016,D=new gl(w),D.addPass(e),D.addPass(Ee),D.addPass(De),D.addPass(new vl)}ee();function R(){r.animationId=requestAnimationFrame(R);let e=performance.now(),t=Math.min((e-a)/1e3,.033);a=e;let n=t*60;if(l+=t*1e3,d+=1,d>=90&&e-p>1e3){let t=l/d,n=t>jl?Math.max(b,s-.1):t<13.5?Math.min(1,s+.05):s;Math.abs(n-s)>.001&&(s=n,ee(),p=e),l=0,d=0}let u=r.started&&!r.gameOver,m=(u?r.speed:.012)*n;for(let e=0;e<r.animatedRoadItems.length;e++){let t=r.animatedRoadItems[e];t.object.position.z+=m*t.speedMul,t.object.position.z>t.resetAfter&&(t.object.position.z-=t.resetBy)}let h=(u?r.speed*2.8:.025)*n;for(let e=0;e<r.wheelGroups.length;e++)r.wheelGroups[e].rotation.x-=h;if(u){r.score+=.2*n,r.speed=Math.min(Ol,Dl+r.score/2400);let t=Math.floor(r.score);t!==r.lastUiScore&&(r.lastUiScore=t,i(t));let a=Ll(r.speed);a!==r.lastUiSpeed&&(r.lastUiSpeed=a,o(a)),ve.position.x+=(r.targetX-ve.position.x)*Math.min(1,.16*n),ve.position.y=Math.sin(e*.013)*.015;let s=r.targetX-ve.position.x;ve.rotation.z=s*-.06,ve.rotation.y=s*-.04;for(let e=0;e<r.obstacles.length;e++){let t=r.obstacles[e];if(t.position.z+=r.speed*n,!t.userData.passed&&t.position.z>ve.position.z&&(t.userData.passed=!0,r.score+=25),t.position.z>12&&(t.position.z=-52-Math.random()*24,t.position.x=Cl[Math.floor(Math.random()*Cl.length)],t.userData.passed=!1),Te(ve,t)){r.gameOver=!0,c(!0),f(!0),we&&window.clearTimeout(we),we=window.setTimeout(()=>f(!1),180);break}}}else ve.rotation.z*=.92,ve.rotation.y*=.92;let g=u?60+r.speed*12:60;C.fov+=(g-C.fov)*.08*n,C.updateProjectionMatrix();let _=(r.speed-Dl)/(Ol-Dl),v=C.aspect<.8?Pl:0;C.position.x+=(ve.position.x*.25-C.position.x)*.05*n,C.position.y+=(Ml-_*.28-C.position.y)*.035*n,C.position.z+=(Nl+v-_*.62-C.position.z)*.035*n,C.lookAt(ve.position.x*.2,1+_*.14,-5.6-_*.9),M.time.value=e*.001,M.speed.value=_,Ee&&De&&(Ee.strength=.1+_*.03,De.uniforms.uTime.value=e*.001,De.uniforms.uSpeed.value=_),D?D.render():w.render(S,C)}R();let Oe=null,ke=()=>{Oe||=requestAnimationFrame(()=>{Oe=null,t&&(C.aspect=t.clientWidth/t.clientHeight,C.updateProjectionMatrix(),Ee&&Ee.resolution.set(t.clientWidth,t.clientHeight),ee())})};return window.addEventListener(`resize`,ke,{passive:!0}),()=>{cancelAnimationFrame(r.animationId),Oe&&cancelAnimationFrame(Oe),we&&window.clearTimeout(we),window.removeEventListener(`keydown`,Ce),window.removeEventListener(`resize`,ke),t.contains(w.domElement)&&t.removeChild(w.domElement),D&&D.dispose(),E.dispose(),T.dispose(),S.environment=null,S.traverse(e=>{e.material&&!Object.values(N).includes(e.material)&&!ye.includes(e.material)&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),w.dispose(),Object.values(P).forEach(e=>e.dispose()),Object.values(N).forEach(e=>e.dispose()),ye.forEach(e=>e.dispose()),r.obstacles=[],r.animatedRoadItems=[],r.wheelGroups=[],r.moveLane=null}},[]);let p=()=>{n.current.resetGame?.()},m=e=>{n.current.moveLane?.(e)},h=e=>t=>{t.preventDefault(),t.stopPropagation(),m(e)},g=e=>{e.pointerType!==`mouse`&&(t.current=e.clientX)},v=e=>{if(e.pointerType===`mouse`||t.current===null)return;let n=e.clientX-t.current;t.current=null,Math.abs(n)>36&&m(n>0?1:-1)},y=Il((a-kl)/(Al-kl),0,1),b=Math.round(y*260),x={background:`conic-gradient(from -130deg, #22d3ee 0deg, #facc15 ${b}deg, rgba(255,255,255,0.16) ${b}deg 260deg, transparent 260deg 360deg)`},S=s?`RETRY`:l?`RESET`:`START`;return(0,$.jsx)(`div`,{className:`relative min-h-screen w-full overflow-hidden bg-[#06101d] text-white`,style:{minHeight:`100vh`,height:`100dvh`},children:(0,$.jsxs)(`div`,{className:`relative h-[100svh] min-h-[540px] w-full overflow-hidden bg-slate-900 touch-none select-none`,style:{minHeight:540,height:`100dvh`,width:`100%`},onPointerDown:g,onPointerUp:v,children:[(0,$.jsx)(`div`,{ref:e,className:`h-full w-full`,style:{height:`100%`,width:`100%`}}),(0,$.jsx)(`style`,{children:`
